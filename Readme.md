#  Test tasks 
Intelogis
Оформить тестовое задание с логотипом компании
на анлгийском языке

Использовать фирменный стиль и дизайн их
Разделение на 2 экрана
скроллинг заявок

высоту карты настроить на автоматическую

Оформить html файл, пакеты json поменять всй оформление\ссылки на проекты


Дать предложения по усовершенсвованию их программы (не обязательно)
